...
const Card = ({ violation, index }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: 'flex justify-between border-b border-gray-600 py-2' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'w-1/10' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, index + 1)),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'w-8/10 px-2' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: 'font-bold' }, violation.description),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'w-1/10' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", { className: `${getImpactColour(violation.impact)} px-2 py-.5 rounded-md` }, violation.impact))));
};
...
const Popup = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'flex flex-col w-full h-screen' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", { className: 'fixed top-0 left-0 right-0 flex justify-between items-center p-4 bg-gray-900 text-black shadow-md' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'flex space-x-1' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Buttons__WEBPACK_IMPORTED_MODULE_6__.Button, { onClick: handleClick, className: 'px-4 bg-gray-400 hover:bg-gray-500 rounded' }, "View Violations"),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'sticky bottom-0 left-0 right-0 justify-center items-center flex h-12' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", { onSubmit: handleSubmit, className: 'flex justify-center w-full' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { ref: inputRef, className: '\n                            w-3/4\n                            mx-auto\n                            p-2\n                            rounded-md \n                            border-2 \n                            border-gray-300 \n                            focus:outline-none \n                            focus:border-blue-500\n                            disabled:bg-white\n                            font-size-lg\n                        ', value: input, onChange: (e) => setInput(e.target.value), placeholder: `${loading ? loadingText : 'Type your message here...'}`, disabled: loading })))));
};
